...
parser.add_argument("-c", "--cpkt", type=str, default='/home/lab602.demo/.pipeline/10678031/myYolo/yolov3_good.pth',
                    help='pth')
...
def main():
    ...
    model.cuda(args.gpu)
    # print(args.cpkt)
    model.load_state_dict(torch.load(args.cpkt, map_location=device))
    ...
    cv2.imwrite('/home/lab602.demo/.pipeline/10678031/myYolo/dog_test_voc.jpg', img)
